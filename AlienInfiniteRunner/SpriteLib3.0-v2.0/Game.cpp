...
void Game::InitGame()
{
	//Initializes the backend with window width and height values, set in increments in 8
	BackEnd::InitBackEnd((128 * 10), (128 * 5));
	...
	//Our game scene, delete the others.
	m_scenes.push_back(new InfiniteRunner("rUnNeR gAeM"));
	 
	//Sets active scene reference to our scene, number relates to which scene to display.
